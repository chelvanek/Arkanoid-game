...
public:
	...
	virtual bool Init() {
		...
		//assigning sprites
		const char* block_path = "data/01-Breakout-Tiles.png";
		const char* ball_path = "data/63-Breakout-Tiles.png";
		const char* paddle_path = "data/50-Breakout-Tiles.png";
		const char* slowed_paddle_path = "data/41-Breakout-Tiles.png";
		const char* wall_path = "data/wall.png";
		const char* cursor_path = "data/59-Breakout-Tiles.png";
		const char* orngblock_path = "data/09-Breakout-Tiles.png";
		const char* green_ability_path = "data/22-Breakout-Tiles.png";
		const char* red_ability_path = "data/24-Breakout-Tiles.png";
